<?php
	...
	$result = sqlsrv_query($sqlConnection, $tsql, array($season));
	if ($result == FALSE)
	{
		echo "query borken.";
	}
	...
	{
		echo '<p>Unexpected season number.</p>';
		exit;
	}
?>
...
<title>UK Pinball League - <?=$seasonYear;?> Finals</title>
...
<?php
	...
	echo "<h1>League Finals $seasonYear ";
...
";
	...
	$finalsResult = sqlsrv_query($sqlConnection, $tsql, array($seasonId));
