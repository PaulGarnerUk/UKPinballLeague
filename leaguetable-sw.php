...
<title>UK Pinball League – South West League 2020/Season 14</title>
...
<h1>South West League <span style="white-space:nowrap">2020/Season 14</span></h1>
...
$query = "SELECT * FROM LeagueTableSW14 ORDER BY best4 DESC, player";  
...
echo "<thead>
			<tr class='white'>
                ...
                <th>Player</th>
				<th>Played</th>
				<th><a href=\"meet.php?scores=SW%2014.1&amp;meet=Meet%201,%2001.03.20\" class='link'>Meet 1</a></th>
				<th>Meet 2</th>
				<th>Meet 3</th>
				<th>Meet 4</th>
				<th>Meet 5</th>
...
<p><a href="previous-leaguetable-sw.php" class="link">View league tables from previous seasons</a>.</p>
