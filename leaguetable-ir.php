...
<title>UK Pinball League – Irish League 2020/Season 14</title>
...
<h1>Irish League <span style="white-space:nowrap">2020/Season 14</span></h1>
...
$query = "SELECT * FROM LeagueTableIR14 ORDER BY best4 DESC, player";  
...
echo "<thead>
			<tr class='white'>
                ...
                <th>Player</th>
				<th>Played</th>
				<th><a href=\"http://ukpinballleague.co.uk/meet.php?scores=IR%2014.1&amp;meet=Meet%201,%2023.02.20\" class='link'>Meet 1</th>
				<th>Meet 2</th>
				<th>Meet 3</th>
				<th>Meet 4</th>
				<th>Meet 5</th>
...
<p><a href="previous-leaguetable-ir.php" class="link">View league tables from previous seasons</a>.</p>
